...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTextMeshProText : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshPro>().DOText(to.Value, duration.Value, richTextEnabled.Value, scrambleMode, scrambleChars.Value);
            ...
            tween.Play();
            if(debugThis.Value) State.Debug("DOTween TextMeshPro Text");
