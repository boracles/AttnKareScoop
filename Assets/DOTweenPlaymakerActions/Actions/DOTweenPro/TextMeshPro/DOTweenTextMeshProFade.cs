...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a TextMeshPro's alpha color to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenTextMeshProFade : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshPro>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshPro Fade");
