...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTextMeshProMaxVisibleCharacters : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshPro>().DOMaxVisibleCharacters(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshPro MaxVisibleCharacters");
