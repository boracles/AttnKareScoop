...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a TextMeshPro faceColor's alpha to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenTextMeshProFaceFade : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshPro>().DOFaceFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshPro FaceFade");
