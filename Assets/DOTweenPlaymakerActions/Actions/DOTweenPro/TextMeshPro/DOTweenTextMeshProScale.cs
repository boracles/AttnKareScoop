...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a TextMeshPro's scale to the given value (using correct uniform scale as TMP requires).")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenTextMeshProScale : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshPro>().DOScale(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshPro Scale");
