...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a TextMeshProUGUI faceColor's alpha to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenTextMeshProUGUIFaceFade : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshProUGUI>().DOFaceFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshProUGUI FaceFade");
