...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTextMeshProUGUIText : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshProUGUI>().DOText(to.Value, duration.Value, richTextEnabled.Value, scrambleMode, scrambleChars.Value);
            ...
            tween.Play();
            if(debugThis.Value) State.Debug("DOTween TextMeshProUGUI Text");
