...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a TextMeshProUGUI's color to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenTextMeshProUGUIColor : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TextMeshProUGUI>().DOColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween TextMeshProUGUI Color");
